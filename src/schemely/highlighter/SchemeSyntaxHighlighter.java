...
public class SchemeSyntaxHighlighter extends SyntaxHighlighterBase implements Tokens
{
  ...
  static
  {
    ...
    createTextAttributesKey(NUMBER_ID, defaultFor(DefaultLanguageHighlighterColors.CONSTANT));
    createTextAttributesKey(STRING_ID, defaultFor(SyntaxHighlighterColors.STRING));
    createTextAttributesKey(BRACES_ID, darker(DefaultLanguageHighlighterColors.BLOCK_COMMENT));
    createTextAttributesKey(PAREN_ID, darker(DefaultLanguageHighlighterColors.BLOCK_COMMENT));
    createTextAttributesKey(LITERAL_ID, defaultFor(DefaultLanguageHighlighterColors.CONSTANT));
    ...
    createTextAttributesKey(PROCEDURE_ID, defaultFor(DefaultLanguageHighlighterColors.NUMBER));
    createTextAttributesKey(QUOTED_TEXT_ID, darker(EditorColors.INJECTED_LANGUAGE_FRAGMENT));
    createTextAttributesKey(QUOTED_STRING_ID, darker(EditorColors.INJECTED_LANGUAGE_FRAGMENT));
    createTextAttributesKey(QUOTED_NUMBER_ID, darker(EditorColors.INJECTED_LANGUAGE_FRAGMENT));
  }
...
//    fillMap(ATTRIBUTES, NUMBER, NUMBER_LITERAL);
    ...
    fillMap(ATTRIBUTES, LITERAL, Tokens.BOOLEAN_LITERAL, NUMBER_LITERAL);
  ...
  private static TextAttributes darker(TextAttributesKey key)
  {
    TextAttributes attributes = key.getDefaultAttributes().clone();
    ...
    if (foregroundColor != null)
    {
      attributes.setBackgroundColor(foregroundColor.brighter());
    }
    else
    {
