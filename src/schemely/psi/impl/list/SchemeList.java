...
public class SchemeList extends SchemeListBase implements SchemeBraced
{
  ...
  private static final String QUASISYNTAX = "quasisyntax";
  private static final String UNSYNTAX = "unsyntax";
  private static final String UNSYNTAX_SPLICING = "unsyntax-splicing";
  ...
  public int getQuotingLevel()
  {
    ...
    if (QUOTE.equals(headText) || QUASIQUOTE.equals(headText) || SYNTAX.equals(headText) || QUASISYNTAX.equals(headText))
    {
      return 1;
    }
    else if (UNQUOTE.equals(headText) || UNQUOTE_SPLICING.equals(headText) || UNSYNTAX.equals(headText) || UNSYNTAX_SPLICING.equals(headText))
    {
      return -1;
    }
    return 0;
